...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void printKeyHash() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.nghiatv.uberdemo", PackageManager.GET_SIGNATURES);
                                    ...
                                    .addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            if (!dataSnapshot.child(account.getId()).exists()) {  // if not exists                                               // if not exists
                                                ...
                                                driver.setName(account.getPhoneNumber().toString());
                                                driver.setPhone(account.getPhoneNumber().toString());
                                                driver.setAvatarUrl("");
                                                driver.setRate("0.0");
                                                driver.setCarType("UberX");
